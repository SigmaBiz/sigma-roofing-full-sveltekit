...
<section id="faq" class="py-20 bg-gray-50">
  <div class="container mx-auto px-4">
    <div class="text-center mb-16">
      <h2 class="font-bold text-4xl text-gray-800 mb-4">Frequently Asked Questions</h2>
    ...
    <div class="max-w-4xl mx-auto space-y-4">
      {#each faqData as faq, index}
        <div class="bg-white border border-gray-200 hover:shadow-lg transition-shadow rounded-lg">
          ...
          >
            <h3 class="font-semibold text-lg text-gray-800 pr-4 leading-6">
              {faq.question}
            </h3>
    ...
    <div class="text-center mt-12 p-6 bg-emerald-50 rounded-lg border-l-4 border-emerald-600">
